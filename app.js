(function() {
    ...
    var buttonBackgroundColor = document.getElementById('backgroundColorButton');
    ...
    function checkFontName() {
        ...
        fontLink.href = fontName;
        fontLink.rel = "stylesheet";
        document.head.appendChild(fontLink);

        var fontLoader = document.getElementById("fontLoader");
        if(fontLoader === null) {
            var fontLoader = document.createElement('div');
            fontLoader.id = "fontLoader";
            fontLoader.innerText = "a";
            document.body.appendChild(fontLoader);
        }
        var regex = /family=(.*)&/;
        var extractedFontName = fontName.match(regex)[1].replace("+", " ");
        fontLoader.style.fontFamily = extractedFontName;
        // textboxFontName.className = isValidFontName(fontName) ? '' : 'invalid';
        updateGenerate();
    }
    ...
    function renderCodePoint(codePoint, multiplier) {
        ...
        context.font =
            ...
            size + 'px ' + JSON.stringify(extractedFontName);
    ...
    buttonBackgroundColor.onclick = setBackgroundColorTransparent;
